...
.PHONY: test
test: stylelint eslint jsunittest #htmlhint csslint
	@$(call HELPTEXT,$@)
...
setup-tools-js:
	@$(call HELPTEXT,$@)
	npm install --save-dev csslint stylelint eslint eslint-plugin-react jsonlint js-yaml clean-css-cli uglify-js mocha nyc coveralls codecov #htmlhint html-minifier
